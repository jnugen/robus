...
include $(PROJ_ROOT)/cmsis/makesection/make.LPC17xx.gnu
...
#
########################################################################
include $(PROJ_ROOT)/cmsis/makesection/make.rules.ftypes
ADDOBJS     += cmsis/core/core_cm3.o 
ADDOBJS     += cmsis/core/system_LPC17xx.o 
...
#
########################################################################
FWSRC 	= $(wildcard $(PROJ_ROOT)/$(FWLIB)/src/*.c)
FWSRCC  = $(wildcard $(PROJ_ROOT)/$(FWLIB)/src/*.cpp)
FWASM	= $(wildcard $(PROJ_ROOT)/$(FWLIB)/src/*.$(ASM_EXT))
...
#CFLAGS      +=-gdwarf-2
AFLAGS 		+=-gdwarf-2
ADDOBJSS    += $(PROJ_ROOT)/cmsis/core/startup_LPC17xx.o


# Define Required Linker script file in each build mode
LDSCRIPTIROM = $(PROJ_ROOT)/cmsis/makesection/ldscript_rom_$(TOOL).ld
LDSCRIPTIRAM = $(PROJ_ROOT)/cmsis/makesection/ldscript_ram_$(TOOL).ld
...
include $(PROJ_ROOT)/cmsis/makesection/make.rules.build
