...
{
	//UARTSend((LPC_UART_TypeDef *)LPC_UART0, (uint8_t *)buffer, sizeof(buffer));
	UARTSend((LPC_UART_TypeDef *)LPC_UART0, (uint8_t *)buffer, uart_strlen(buffer));
}
